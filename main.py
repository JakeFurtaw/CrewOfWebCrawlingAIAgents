...
from tasks import Load_Example_Data, Question_Crawl, Answer_Crawl, Format_Data, Manager_Agents
...
crew = Crew(
    ...
    tasks=[Load_Example_Data, Question_Crawl, Answer_Crawl, Format_Data],
